...
# Ensure all columns in columns_to_display exist in eval_results_df
columns_to_display = [col for col in columns_to_display if col in eval_results_df.columns]
